...
public class SystemMessageListApapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            try {
                itemViewHolder.tv_announcement_title.setText(URLDecoder.decode(announcement.getNotificationTitle(), "UTF-8"));
                itemViewHolder.tv_announcement_content.setText(URLDecoder.decode(announcement.getNotificationContent(), "UTF-8"));
